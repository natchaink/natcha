...
class _HomePageState extends State<HomePage> { 
  ...
  void initState() { 
    ...
    if (user != null) { 
      _userRef = FirebaseDatabase.instance.ref().child('usersชื่อนศ./${user.uid}'); 
      _fetchUserData(); 
    } else { 
      setState(() { 
        _isLoading = false; 
  ...
  Future<void> _fetchUserData() async { 
   ...
   Widget build(BuildContext context) { 
    ...
    return Scaffold( 
            ...
            UserAccountsDrawerHeader( 
              ...
              currentAccountPicture: CircleAvatar( 
                backgroundImage: _userData?['profileImage'] != null 
                    ? NetworkImage(_userData!['profileImage']) // URL รูปภาพจาก Firebase 
      ...
      body: Center( 
        child: Text( 
          'ยินดีต้อนรับ: Welcome, ${_userData?['firstName'] ?? 'ผู ้ใช้: User'}!', 
